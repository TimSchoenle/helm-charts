...
| [mp-stats-legacy-viewer](charts/mp-stats-legacy-viewer) | This chart deploys mp-stats-legacy-viewer, which serves historical Minecraft server statistics as sharded binary chunks that a Dioxus client queries in the browser. |
...
| [portfolio](charts/portfolio) | This chart deploys Portfolio, a Dioxus fullstack site that an Axum server renders and a WASM client hydrates in the browser. |
