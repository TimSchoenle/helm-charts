...
![Version: 1.4.8](https://img.shields.io/badge/Version-1.4.8-informational?style=flat-square) ![AppVersion: v1.16.0](https://img.shields.io/badge/AppVersion-v1.16.0-informational?style=flat-square)
...
| image.tag | string | `"v1.16.0@sha256:e78800fabeab36d03e5483f28cb1af6e4af38144a1816d0e9891b7710d10b38d"` | Container image tag to deploy. |
