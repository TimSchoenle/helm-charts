...
![Version: 5.10.0](https://img.shields.io/badge/Version-5.10.0-informational?style=flat-square) ![AppVersion: 10.1.0](https://img.shields.io/badge/AppVersion-10.1.0-informational?style=flat-square)
...
| services.api.image | object | `{"repository":"timschoenle/tankovault-api","tag":"v10.1.0@sha256:4dc9de4e267e07a64e23404f066074cd8872a681b7adc5663bd7d5a6f3053799"}` | Repository and tag for this service. Registry and pull policy come from the top-level `image`. |
| services.api.image.repository | string | `"timschoenle/tankovault-api"` | Image repository. |
| services.api.image.tag | string | `"v10.1.0@sha256:4dc9de4e267e07a64e23404f066074cd8872a681b7adc5663bd7d5a6f3053799"` | Image tag, pinned by digest. |
...
| services.challengeSolver.image | object | `{"repository":"timschoenle/tankovault-challenge-solver","tag":"v10.1.0@sha256:a1ad78077fe32495fd22712510328d618d212b89c6132aea29461e9fb67533ed"}` | Repository and tag for this service. Registry and pull policy come from the top-level `image`. |
| services.challengeSolver.image.repository | string | `"timschoenle/tankovault-challenge-solver"` | Image repository. |
| services.challengeSolver.image.tag | string | `"v10.1.0@sha256:a1ad78077fe32495fd22712510328d618d212b89c6132aea29461e9fb67533ed"` | Image tag, pinned by digest. |
...
| services.controlPlane.image | object | `{"repository":"timschoenle/tankovault-control-plane","tag":"v10.1.0@sha256:14f570cb30beedaa0675b57af94414ddb1814b9b692cdd3bff98757b6125fd3d"}` | Repository and tag for this service. Registry and pull policy come from the top-level `image`. |
| services.controlPlane.image.repository | string | `"timschoenle/tankovault-control-plane"` | Image repository. |
| services.controlPlane.image.tag | string | `"v10.1.0@sha256:14f570cb30beedaa0675b57af94414ddb1814b9b692cdd3bff98757b6125fd3d"` | Image tag, pinned by digest. |
...
| services.frontend.image | object | `{"repository":"timschoenle/tankovault-frontend","tag":"v10.1.0@sha256:bfd0122414553999abe3fcc525df45e718bbfc38dbba48feec3d86cc41f02807"}` | Repository and tag for this service. Registry and pull policy come from the top-level `image`. |
| services.frontend.image.repository | string | `"timschoenle/tankovault-frontend"` | Image repository. |
| services.frontend.image.tag | string | `"v10.1.0@sha256:bfd0122414553999abe3fcc525df45e718bbfc38dbba48feec3d86cc41f02807"` | Image tag, pinned by digest. |
...
| services.notifier.image | object | `{"repository":"timschoenle/tankovault-notifier","tag":"v10.1.0@sha256:a58c3a3cdda610c181d9829f1aac4c4372a88a058ea7231f85c00a51b014d657"}` | Repository and tag for this service. Registry and pull policy come from the top-level `image`. |
| services.notifier.image.repository | string | `"timschoenle/tankovault-notifier"` | Image repository. |
| services.notifier.image.tag | string | `"v10.1.0@sha256:a58c3a3cdda610c181d9829f1aac4c4372a88a058ea7231f85c00a51b014d657"` | Image tag, pinned by digest. |
...
| services.render.image | object | `{"repository":"timschoenle/tankovault-render","tag":"v10.1.0@sha256:893f2c667d90bd3d0c281d3c541ec02494918bb5e3a22d71e4b9b9cd08d10eb4"}` | Repository and tag for this service. Registry and pull policy come from the top-level `image`. |
| services.render.image.repository | string | `"timschoenle/tankovault-render"` | Image repository. |
| services.render.image.tag | string | `"v10.1.0@sha256:893f2c667d90bd3d0c281d3c541ec02494918bb5e3a22d71e4b9b9cd08d10eb4"` | Image tag, pinned by digest. |
...
| services.sync.image | object | `{"repository":"timschoenle/tankovault-sync","tag":"v10.1.0@sha256:667e0957f9e01258b59958c94c84c1473a979ffa220f82ccbe7df59613dfcf51"}` | Repository and tag for this service. Registry and pull policy come from the top-level `image`. |
| services.sync.image.repository | string | `"timschoenle/tankovault-sync"` | Image repository. |
| services.sync.image.tag | string | `"v10.1.0@sha256:667e0957f9e01258b59958c94c84c1473a979ffa220f82ccbe7df59613dfcf51"` | Image tag, pinned by digest. |
...
| services.worker.image | object | `{"repository":"timschoenle/tankovault-worker","tag":"v10.1.0@sha256:9170a75e197684f34e70e3c2f757705f546445f8e6a7676a52cb32907ed83c20"}` | Repository and tag for this service. Registry and pull policy come from the top-level `image`. |
| services.worker.image.repository | string | `"timschoenle/tankovault-worker"` | Image repository. |
| services.worker.image.tag | string | `"v10.1.0@sha256:9170a75e197684f34e70e3c2f757705f546445f8e6a7676a52cb32907ed83c20"` | Image tag, pinned by digest. |
