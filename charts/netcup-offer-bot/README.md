...
![Version: 5.0.1](https://img.shields.io/badge/Version-5.0.1-informational?style=flat-square) ![AppVersion: v2.0.1](https://img.shields.io/badge/AppVersion-v2.0.1-informational?style=flat-square)
...
| image.tag | string | `"v2.0.1@sha256:da2a92c2451007040408fa61651bedbd6eb04e759625dc65b904290c3388ddcc"` | The container image tag. Defaults to the chart's `appVersion` when empty. |
