...
![Version: 1.4.16](https://img.shields.io/badge/Version-1.4.16-informational?style=flat-square) ![AppVersion: v1.17.4](https://img.shields.io/badge/AppVersion-v1.17.4-informational?style=flat-square)
...
| image.tag | string | `"v1.17.4@sha256:cc970cc78b9b719fcf4ed8259dd8b4e0e8dbdd9303ac420bbb79c0e33dbd068d"` | Container image tag to deploy. |
