...
![Version: 0.0.23](https://img.shields.io/badge/Version-0.0.23-informational?style=flat-square) ![AppVersion: v0.12.9](https://img.shields.io/badge/AppVersion-v0.12.9-informational?style=flat-square)
...
| image.tag | string | `"v0.12.9@sha256:e03d0a7b685c250173e54aa5a7e085c611addd99dd0dd2128d8960a5b9f93133"` | Container image tag to deploy. Pin to a version for predictable deployments rather than using "latest". |
