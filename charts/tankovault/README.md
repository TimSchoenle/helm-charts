...
| trawl.image | object | `{"repository":"ghcr.io/germondai/trawl","tag":"1.6.5@sha256:c25aefa0f204d0496db9e5e530ff826ffe06f471228c5236e95862e815a9c865"}` | Repository and tag for the bundled TRAWL. |
| trawl.image.repository | string | `"ghcr.io/germondai/trawl"` | Image repository. |
| trawl.image.tag | string | `"1.6.5@sha256:c25aefa0f204d0496db9e5e530ff826ffe06f471228c5236e95862e815a9c865"` | Image tag, pinned by digest. Never `latest`: it silently changes the bot-management behaviour the adapters are tuned against. |
