...
| image.digest | string | `"sha256:0509b22f40e374829a589616281cf5cda882c70c00c8ce4c2498bf3aef5ef0ad"` | Image digest, pinning the deployment to an immutable image. Wins over `tag`. |
