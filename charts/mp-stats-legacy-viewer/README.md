...
![Version: 0.0.7](https://img.shields.io/badge/Version-0.0.7-informational?style=flat-square) ![AppVersion: v0.7.2](https://img.shields.io/badge/AppVersion-v0.7.2-informational?style=flat-square)
...
| image.tag | string | `"v0.7.2@sha256:22fc2b9c1b74c3775ec22a86fbf110c232b79e5a01882a1d75c464d83b7e0a0c"` | Container image tag to deploy. Pin to a version for predictable deployments rather than using "latest". |
