...
![Version: 1.0.2](https://img.shields.io/badge/Version-1.0.2-informational?style=flat-square) ![AppVersion: v0.13.4](https://img.shields.io/badge/AppVersion-v0.13.4-informational?style=flat-square)
...
| image.digest | string | `"sha256:0509b22f40e374829a589616281cf5cda882c70c00c8ce4c2498bf3aef5ef0ad"` | Image digest (`sha256:...`). Combined with `tag` rather than replacing it: the digest pins the pull, while `tag` stays on as the readable version marker. |
...
| image.tag | string | `"v0.13.4@sha256:ae0a254f96d395b9b956b8c142d36e7f598b5ca3c21df1067e5aac6ac9dec3e5"` | The container image tag. Defaults to the chart's `appVersion` when empty. |
