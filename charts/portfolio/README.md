...
![Version: 1.3.5](https://img.shields.io/badge/Version-1.3.5-informational?style=flat-square) ![AppVersion: v1.12.6](https://img.shields.io/badge/AppVersion-v1.12.6-informational?style=flat-square)
...
| image.tag | string | `"v1.12.6@sha256:49bf144aced7e0baf8cd4aecceaaad3ef8ef1e0aab5a30ee3e77e278e2802e06"` | Container image tag to deploy. |
