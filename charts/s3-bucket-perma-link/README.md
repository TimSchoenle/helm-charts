...
![Version: 1.1.20](https://img.shields.io/badge/Version-1.1.20-informational?style=flat-square) ![AppVersion: v0.3.21](https://img.shields.io/badge/AppVersion-v0.3.21-informational?style=flat-square)
...
| image.tag | string | `"v0.3.21@sha256:8005570a790db58c49a3a532007b1869be4ad463e449596ddac7adcddcd710ad"` | Container image tag to deploy. Pin to a version for predictable deployments rather than using "latest". |
