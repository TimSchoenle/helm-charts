...
![Version: 6.2.5](https://img.shields.io/badge/Version-6.2.5-informational?style=flat-square) ![AppVersion: v3.3.2](https://img.shields.io/badge/AppVersion-v3.3.2-informational?style=flat-square)
...
| image | object | `{"pullPolicy":"","registry":"","repository":"timmi6790/netcup-offer-bot","tag":"v3.3.2@sha256:04751641d9bc5f123a987bc2e9be02ae8c43dc126724bcec8ab70dfd2ae98fa1"}` | Container image the pod runs, composed as `registry/repository:tag`. |
...
| image.tag | string | `"v3.3.2@sha256:04751641d9bc5f123a987bc2e9be02ae8c43dc126724bcec8ab70dfd2ae98fa1"` | The container image tag. Defaults to the chart's `appVersion` when empty. |
