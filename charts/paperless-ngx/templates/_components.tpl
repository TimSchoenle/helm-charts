...
{{- $values := dict
      ...
      "affinity" ($ctx.Values.affinity | default dict)
      "podAntiAffinity" ($ctx.Values.podAntiAffinity | default "")
      "topologySpreadConstraints" ($ctx.Values.topologySpreadConstraints | default list)
