...
![Version: 2.0.3](https://img.shields.io/badge/Version-2.0.3-informational?style=flat-square) ![AppVersion: v0.3.23](https://img.shields.io/badge/AppVersion-v0.3.23-informational?style=flat-square)
...
| image.tag | string | `"v0.3.23@sha256:2cd930c5563fb4d7e901c68aec62c45cf60850c1e7293131851bb0a790f51c50"` | The container image tag, pinned by digest (`vX.Y.Z@sha256:...`). The digest pins the pull, while the tag stays on as the readable version marker. Defaults to the chart's `appVersion` when empty. |
