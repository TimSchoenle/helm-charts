...
![Version: 3.0.0](https://img.shields.io/badge/Version-3.0.0-informational?style=flat-square) ![AppVersion: v2.1.3](https://img.shields.io/badge/AppVersion-v2.1.3-informational?style=flat-square) 
...
| image.digest | string | `"sha256:722e3ead404823fc5a12b71b9780eb12484c4a560ecce30c2129e3e5c5b456ad"` | Image digest (`sha256:...`). Combined with `tag` rather than replacing it: the digest pins the pull, while `tag` stays on as the readable version marker. |
...
| image.tag | string | `"v2.1.3"` | Container image tag to deploy. Defaults to the chart's `appVersion` when empty. |
