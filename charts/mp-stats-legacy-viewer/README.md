...
![Version: 0.0.4](https://img.shields.io/badge/Version-0.0.4-informational?style=flat-square) ![AppVersion: v0.4.0](https://img.shields.io/badge/AppVersion-v0.4.0-informational?style=flat-square)
...
| image.tag | string | `"v0.4.0@sha256:cf020f64b02c814da601b334163c26b69bfc5d68e5db9b9a4e335e900af83653"` | Container image tag to deploy. Pin to a version for predictable deployments rather than using "latest". |
