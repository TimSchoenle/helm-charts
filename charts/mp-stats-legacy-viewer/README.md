...
![Version: 0.0.24](https://img.shields.io/badge/Version-0.0.24-informational?style=flat-square) ![AppVersion: v0.12.10](https://img.shields.io/badge/AppVersion-v0.12.10-informational?style=flat-square)
...
| image.tag | string | `"v0.12.10@sha256:efd1256a76a1f0d4407e73edca6e0fbd5db19bd100bfa1c9db8a7a5c832e34af"` | Container image tag to deploy. Pin to a version for predictable deployments rather than using "latest". |
