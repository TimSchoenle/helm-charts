...
![Version: 1.4.21](https://img.shields.io/badge/Version-1.4.21-informational?style=flat-square) ![AppVersion: v1.17.9](https://img.shields.io/badge/AppVersion-v1.17.9-informational?style=flat-square)
...
| image.tag | string | `"v1.17.9@sha256:45b512caf8c91f8a1bbbf7136440d6fe1bef75dedc5d5bdfd3ad4847c57c7c60"` | Container image tag to deploy. |
