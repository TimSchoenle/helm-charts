...
![Version: 1.1.10](https://img.shields.io/badge/Version-1.1.10-informational?style=flat-square) ![AppVersion: v0.3.10](https://img.shields.io/badge/AppVersion-v0.3.10-informational?style=flat-square)
...
| image.tag | string | `"v0.3.10@sha256:800f4132ff88b507a9981857e397f94ace789141c8eb56f666f264b557712233"` | Container image tag to deploy. Pin to a version for predictable deployments rather than using "latest". |
