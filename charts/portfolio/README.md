...
![Version: 1.4.12](https://img.shields.io/badge/Version-1.4.12-informational?style=flat-square) ![AppVersion: v1.17.0](https://img.shields.io/badge/AppVersion-v1.17.0-informational?style=flat-square)
...
| image.tag | string | `"v1.17.0@sha256:dfc458405c731652625cfcac4dc895150c5900b53563ce223a16f858e9fa6cbf"` | Container image tag to deploy. |
