...
![Version: 0.0.14](https://img.shields.io/badge/Version-0.0.14-informational?style=flat-square) ![AppVersion: v0.12.0](https://img.shields.io/badge/AppVersion-v0.12.0-informational?style=flat-square)
...
| image.tag | string | `"v0.12.0@sha256:79ad6f117ed60ea66db74af2ca2b8ca342fa9f9ad82e7d6eecf746529d695d55"` | Container image tag to deploy. Pin to a version for predictable deployments rather than using "latest". |
