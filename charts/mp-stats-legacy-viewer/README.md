...
![Version: 0.0.17](https://img.shields.io/badge/Version-0.0.17-informational?style=flat-square) ![AppVersion: v0.12.3](https://img.shields.io/badge/AppVersion-v0.12.3-informational?style=flat-square)
...
| image.tag | string | `"v0.12.3@sha256:ab1102923b0181afe0b0c14dea5df578a37c29902c10d6f64da9e223765eee2b"` | Container image tag to deploy. Pin to a version for predictable deployments rather than using "latest". |
