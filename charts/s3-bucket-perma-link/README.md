...
| image.digest | string | `"sha256:99638220674a86fe194c4aeccfe2d8ad50a62f56bad4661892ed2959e76a9660"` | Image digest, pinning the deployment to an immutable image. Wins over `tag`. |
