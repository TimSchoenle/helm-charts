...
![Version: 5.1.2](https://img.shields.io/badge/Version-5.1.2-informational?style=flat-square) ![AppVersion: 8.1.1](https://img.shields.io/badge/AppVersion-8.1.1-informational?style=flat-square)
...
| services.api.image.tag | string | `"v7.3.0@sha256:263d7e9d4ffba30ab38a942de4d1610030c89286394b0ded198cc6d2a3951517"` | Image tag, pinned by digest. |
...
| services.challengeSolver.image.tag | string | `"v7.3.0@sha256:9367ed66ae73ad93e7b0c1533eff10e523d59e928fef973615f692deec7e1269"` | Image tag, pinned by digest. |
...
| services.controlPlane.image.tag | string | `"v7.3.0@sha256:a161729c3d948dc5a7a48cd1115e0a4d7ce2c2df8e7481d9261686eabcac0985"` | Image tag, pinned by digest. |
...
| services.frontend.image.tag | string | `"v8.1.1@sha256:bfc623eaae9a6de9147002a01ef3ad20dad869aada79677fb2dc3ec35a6fec68"` | Image tag, pinned by digest. |
...
| services.notifier.image.tag | string | `"v7.3.0@sha256:72c8358a7852676cd53bcd1a257f845e517df9ba4a2bf9abb10534998224dfec"` | Image tag, pinned by digest. |
...
| services.render.image.tag | string | `"v7.3.0@sha256:50d8c8403ba8bb75ee9fd62c33579142512a5498ae23c02946be893e242064ef"` | Image tag, pinned by digest. |
...
| services.sync.image.tag | string | `"v7.3.0@sha256:3b48f41af8c19281c1c0866a3a0f03f9d3a4a7ba468a89df70814b040c38b69e"` | Image tag, pinned by digest. |
...
| services.worker.image.tag | string | `"v7.3.0@sha256:77294cd2b18e7f8a9cb0a32ebf90e7ed54f4d6b8343755d6766ba9b2d82d0d3a"` | Image tag, pinned by digest. |
